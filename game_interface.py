...
heading_label = tk.Label(root, text="Rock Paper Scissors", font=("Helvetica", 18))
...
scores_heading_label = tk.Label(root, text="Scores", font=("Helvetica", 14))
scores_heading_label.pack()
...
computer_score_label.grid(row=0, column=1, padx=5)
root.mainloop()
